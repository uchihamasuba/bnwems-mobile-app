...
class TechnicalCollectionChecklistScreen extends StatefulWidget {
  ...
  @override
  State<TechnicalCollectionChecklistScreen> createState() =>
      _TechnicalCollectionChecklistScreenState();
}

class _TechnicalCollectionChecklistScreenState
    extends State<TechnicalCollectionChecklistScreen> {
  ...
  void _submitCollection() {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
          content: Text('Đã báo cáo thu hồi thiết bị về cho Leader xác nhận!')),
    );
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                              'Đã thu hồi: ${item['collected']}/${item['total']}',
                              style: const TextStyle(
                                  fontSize: 12,
